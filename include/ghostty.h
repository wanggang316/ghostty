...
GHOSTTY_API uint64_t ghostty_surface_child_process_id(ghostty_surface_t);
GHOSTTY_API uint64_t ghostty_surface_foreground_process_group(ghostty_surface_t);
